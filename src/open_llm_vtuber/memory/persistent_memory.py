...
_FACT_EXTRACT_SYSTEM = (
    ...
    "**出力形式（厳守）**：\n"
    '[{"fact": "ユーザーは物理学部出身で物理学を専攻していた"}, '
    '{"fact": "ユーザーはWindowsを使用している"}]\n'
...
_DIARY_SYSTEM = (
    ...
    "【重視する内容】\n"
    "出来事の流水的な羅列ではなく、後から参照して価値のある情報を中心に書く：\n"
    "- 未解決の約束・タスク・宿題\n"
    ...
    "- 軽く触れただけの話題は「〇〇の話題にも少し触れた」程度で済ませる。\n"
    "- 深く議論した話題は、ユーザーの主な意見・主張、自分の反応、"
    "二人で達した結論や論点などを記録する。後から要旨を再現できる"
    "程度の情報量を残す。\n\n"
    "【省いてよい内容】\n"
    ...
    "長さは内容次第で柔軟に。短ければ1段落、話題が多ければ2段落程度まで。\n\n"
