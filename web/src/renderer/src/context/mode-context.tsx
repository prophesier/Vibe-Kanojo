...
export const ModeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Expose the pet-mode flag to the WebSDK (a lower layer that has no notion
  // of app modes) so onMouseMoved can switch its gaze coordinate transform.
  // See lappdelegate.onMouseMoved.
  useEffect(() => {
    (window as any).__isPetMode = mode === 'pet';
  }, [mode]);
